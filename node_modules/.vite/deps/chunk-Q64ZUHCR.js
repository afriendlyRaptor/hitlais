import {
  ...
  useLazyRef,
  useReducedMotion
} from "./chunk-N4JVHFSV.js";
import {
  elementTypeAcceptingRef_default,
  refType_default
} from "./chunk-MWFDDFMF.js";
import {
  useForkRef_default
} from "./chunk-EIROFGK4.js";
import {
  memoTheme_default
} from "./chunk-45MXMVXQ.js";
import {
  composeClasses,
  css,
  ...
  useDefaultProps,
  useTheme
} from "./chunk-32LRNRIN.js";
import {
  clsx_default
} from "./chunk-U7P2NEEE.js";
import {
  require_jsx_runtime
} from "./chunk-N46KHF4R.js";
import {
  require_react
...
function Ripple(props) {
  ...
  const exitTimerStartedRef = React5.useRef(false);
  const onExitedRef = React5.useRef(onExited);
...
var TouchRipple = React6.forwardRef(function TouchRipple2(inProps, ref) {
  ...
  const [rippleState, setRippleState] = React6.useState({
    items: EMPTY_ARRAY,
    order: EMPTY_ARRAY
  });
  ...
  const mountedRef = React6.useRef(false);
  useOnMount(() => {
...
var ButtonBaseRoot = styled_default("button", {
  ...
  variants: [{
    ...
    style: theme.focusVisible && {
      ...outsetFocusRing,
      [`&.${buttonBaseClasses_default.focusVisible}`]: theme.focusVisible
    }
  }]
})));
...
//# sourceMappingURL=chunk-Q64ZUHCR.js.map
